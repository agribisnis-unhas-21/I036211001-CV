...
productContainer.addEventListener('click', function(e){
    if(e.target.className == 'btn-buy'){
        window.open("https://api.whatsapp.com/send/?phone=6287750157979&text="+pesanPembuka+" *"+namaProduct.textContent+"* (" + hargaProduct.textContent + ") sebanyak *" +numSpinner.value + "*. " + pesanPenutup);
    };
});
